...
The Finnish Self-Report Delinquency Study is a nationally representative crime survey among 15--16 year-olds (Kaakinen & Näsi 2021; Kaakinen et al. 2022). Following the logic of this report, it is of some interest to compare the FSRD survey-based findings with the police-recorded crime trends in the age category 15 to 17. These comparisons are shown in Figure 5. Note that the police-recorded offending figure is offence-based while the survey observations are person-based. Also, the vertical scales differ it is a percentage for the survey and rate per 1,000 persons for the administrative statistic. Overall, the two sources largely agree on the direction of change in the three offence categories examined: a clear decrease in the first part of the observation decade was followed by a more stable phase. The administrative crime statistics and the self-reports-based survey source thus crossvalidate one another in the domain of youth crime.
...
figure1_y7 <- read_excel("C:/Users/ikolttol/Downloads/crime_trends/data_eng.xlsx",sheet="figure7")
...
figure1_y8 <- read_excel("C:/Users/ikolttol/Downloads/crime_trends/data_eng.xlsx",sheet="figure7")
...
figure1_y9 <- read_excel("C:/Users/ikolttol/Downloads/crime_trends/data_eng.xlsx",sheet="figure9")
